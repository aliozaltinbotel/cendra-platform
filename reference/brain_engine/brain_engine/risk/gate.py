...
from brain_engine.risk.cvar import DEFAULT_ALPHA, compute_risk
from brain_engine.risk.models import (
    OutcomeSample,
    RiskEstimate,
    RiskVerdict,
)
...
class RiskGate:
    ...
    def __init__(
        ...
        *,
        ...
        self._log = logger.bind(component="risk_gate")
    ...
    def decide(
        ...
        if estimate.cvar > self._cvar_threshold:
            ...
            return RiskGateDecision(
                ...
                threshold=self._cvar_threshold,
                rationale=(
                    f"cvar={estimate.cvar:.3f} > "
                    f"threshold={self._cvar_threshold:.3f} "
