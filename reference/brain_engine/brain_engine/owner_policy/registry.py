...
:class:`brain_engine.planner.OwnerStyleResolver` Protocol that the
:class:`brain_engine.planner.StyleSelector` consults first when
...
class DSLOwnerResolver:
    ...
    def __init__(
        ...
        *,
        ...
        self._jurisdictions: dict[str, str] = dict(
...
def load_owner_policy(
    *,
    ...
    Returns:
        ...
        :class:`brain_engine.planner.StyleSelector`.
