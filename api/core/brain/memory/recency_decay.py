...
from core.brain.memory.fact_extraction import ExtractedFact
...
def apply_recency_decay(
    ...
    *,
    ...
    """
    materialised: Sequence[ExtractedFact] = list(facts) if not isinstance(facts, Sequence) else facts
    ...
    for fact in materialised:
        ...
        age_seconds = max(
            0.0,
            (reference - timestamp).total_seconds(),
        )
