...
encoder used by :class:`core.brain.memory.semantic_memory.SemanticMemory`
...
# ``core.brain.memory.semantic_memory._DEFAULT_EMBEDDING_MODEL`` and
...
SPRINT_A_EMBEDDING_MODEL: Final[str] = "mixedbread-ai/mxbai-embed-large-v1"
...
def resolve_embedding_dim() -> int:
    ...
    logger.warning(
        "Unknown embedding model %r — falling back to dim=%d. Set %s explicitly to silence this warning.",
        model,
