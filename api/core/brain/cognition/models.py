...
class AceCycle:
    ...
    def __post_init__(self) -> None:
        ...
        if self.curator_applied and self.reflector_verdict is not AceVerdict.APPROVE:
            raise ValueError("curator_applied=True only allowed when reflector_verdict is APPROVE")
