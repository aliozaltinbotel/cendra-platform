...
1. **Wilson lower bound** on the empirical success rate
   (:func:`core.brain.patterns.wilson.wilson_lower_bound`).
...
:mod:`core.brain.patterns.postgres_rule_store`) + Wilson + a
...
from core.brain.abstention.protocols import CalibrationStore
...
class ConformalCalibrator:
    ...
    def conformal_threshold(
        ...
        *,
        ...
        samples = self._store.samples_for(tool_id)
        failed_confidences = [s.predicted_confidence for s in samples if not s.actual_success]
